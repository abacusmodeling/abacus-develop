...
public:
	...
	static void search(Grid_Driver &grid_d, const UnitCell &ucell, const double& search_radius_bohr);
	...
	//2015-05-07
	static void delete_vector(Grid_Driver &grid_d, const UnitCell &ucell, const double &search_radius_bohr);
