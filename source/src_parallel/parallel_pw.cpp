...
// 	{
// 		int m1 = (int)GlobalC::sf.gdirect_global[ig].x;
// 		int m2 = (int)GlobalC::sf.gdirect_global[ig].y;
...
// 		if (this->isind[mc] >= 0)
// 		{
// 			if (GlobalC::sf.gg_global[ig] <= this->gcut)
// 			{
// 				this->ig_l2g[ngm_i] = ig;
// 				if(this->gcut == GlobalC::sf.ggchg) // for charge, not for wave functions.
// 				{
// 					// set 
// 					GlobalC::sf.gdirect[ngm_i] = GlobalC::sf.gdirect_global[ig];
// 					GlobalC::sf.gcar[ngm_i] = GlobalC::sf.gdirect[ngm_i]*GlobalC::ucell.G;
// 					GlobalC::sf.gg[ngm_i] = GlobalC::sf.gg_global[ig];
// 				}
// 				++ngm_i;
// 			}
// 		}
...
// 		int x = int(GlobalC::sf.gdirect_global[this->ig_l2g[ig]].x);
// 		int y = int(GlobalC::sf.gdirect_global[this->ig_l2g[ig]].y);
// 		int z = int(GlobalC::sf.gdirect_global[this->ig_l2g[ig]].z);
...
//     if(this->gcut == GlobalC::sf.ggchg) ngm_i2 = ngm_i_number[ggchg_time-1];
//     for (int ig = ngm_i_record2;ig < ngm_i2;ig++)
//     {
//         if(this->gcut == GlobalC::sf.ggchg)
//         {
//             GlobalC::sf.gcar[ig] = GlobalC::sf.gdirect[ig]*GlobalC::ucell.G;
//             GlobalC::sf.gg[ig] = GlobalC::sf.get_NormG_cartesian(ig);
//         }
//     }


//     if(this->gcut == GlobalC::sf.ggchg) ngm_i_record2 = ngm_i2;
...
// 				{
// 					// set 
// 					GlobalC::sf.gdirect[ngm_i_final_scf] = GlobalC::sf.gdirect_global[ig];
// 					GlobalC::sf.gcar[ngm_i_final_scf] = GlobalC::sf.gdirect[ngm_i_final_scf]*GlobalC::ucell.G;
// 					GlobalC::sf.gg[ngm_i_final_scf] = GlobalC::sf.gg_global[ig];
// 				}
// 				++ngm_i_final_scf;
// 			}
// 		}
