                            ...
                            if (nug >= 0)
                            {
                                if (mug <= nug)
                                {
                                    ...
                                    else
                                    {
                                        // spin = 1;
                                        // spin = 2;
                                        tmp[j] = pvp_nc[1][mug0][nug0]
                                                 + sign * std::complex<double>(0.0, 1.0) * pvp_nc[2][mug0][nug0];
                                    }
                                }
                                else
                                {
                                    ...
                                    else
                                    {
                                        // spin = 1;
                                        // spin = 2;
                                        tmp[j] = conj(pvp_nc[1][nug0][mug0]
                                                      + sign * std::complex<double>(0.0, 1.0) * pvp_nc[2][nug0][mug0]);
                                    }
                                }
                            }
                        }
