...
public:
	static size_t get_index_index( 
		const ModuleBase::Element_Basis_Index::IndexLNM &index_A, const size_t &TA, const size_t &LA, const size_t &NA, const size_t &MA, 
		const ModuleBase::Element_Basis_Index::IndexLNM &index_B, const size_t &TB, const size_t &LB, const size_t &NB, const size_t &MB )
