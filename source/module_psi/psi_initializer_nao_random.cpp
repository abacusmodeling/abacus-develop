...
#ifdef __MPI
psi_initializer_nao_random::psi_initializer_nao_random(Structure_Factor* sf_in, ModulePW::PW_Basis_K* pw_wfc_in, UnitCell* p_ucell_in, Parallel_Kpoints* p_parakpts_in, int random_seed_in)
                           : psi_initializer_nao(sf_in, pw_wfc_in, p_ucell_in, p_parakpts_in, random_seed_in)
#else
psi_initializer_nao_random::psi_initializer_nao_random(Structure_Factor* sf_in, ModulePW::PW_Basis_K* pw_wfc_in, UnitCell* p_ucell_in, int random_seed_in)
                           : psi_initializer_nao(sf_in, pw_wfc_in, p_ucell_in, random_seed_in)
#endif
{
...
void psi_initializer_nao_random::initialize_only_once(pseudopot_cell_vnl* p_pspot_nl_in)
{
    psi_initializer_nao::initialize_only_once();
}
