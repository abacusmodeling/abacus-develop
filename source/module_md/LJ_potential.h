...
public:
    ...
    static double Lennard_Jones(UnitCell_pseudo &ucell_c, Grid_Driver &grid_neigh, ModuleBase::Vector3<double> *force, ModuleBase::matrix &stress);
    static double Lennard_Jones(UnitCell_pseudo &ucell_c, CMD_neighbor &cmd_neigh, ModuleBase::Vector3<double> *force, ModuleBase::matrix &stress);
