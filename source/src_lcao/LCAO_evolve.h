...
class Evolve_LCAO_Matrix
{
    ...
    void evolve_complex_matrix(const int& ik, psi::Psi<std::complex<double>>* psi)const;
...
#ifdef __MPI
	int using_ScaLAPACK_complex(const int &ik, psi::Psi<std::complex<double>>* psi)const;
#endif
};
