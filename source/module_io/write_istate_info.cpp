                    ...
                    for (int ik = 0; ik < kv->nks; ik++)
                    {
                        ...
                        for (int ib = 0; ib < GlobalV::NBANDS; ib++)
                        {
                            ofsi2 << std::setw(6) << ib + 1 << std::setw(25)
                                  << pelec->ekb(ik, ib) * ModuleBase::Ry_to_eV << std::setw(25) << pelec->wg(ik, ib)
                                  << std::endl;
                        }
                        ofsi2 << std::endl;
                        ofsi2 << std::endl;
                ...
                else
                {
                    for (int ik = 0; ik < kv->nks / 2; ik++)
                    {
                        ...
                        for (int ib = 0; ib < GlobalV::NBANDS; ib++)
                        {
                            ofsi2 << std::setw(6) << ib + 1 << std::setw(25)
                                  << pelec->ekb(ik, ib) * ModuleBase::Ry_to_eV << std::setw(25) << pelec->wg(ik, ib)
                                  << std::setw(25) << pelec->ekb((ik + kv->nks / 2), ib) * ModuleBase::Ry_to_eV
                                  << std::setw(25) << pelec->wg(ik + kv->nks / 2, ib) << std::endl;
                        }
                        ofsi2 << std::endl;
                        ofsi2 << std::endl;
                    }
