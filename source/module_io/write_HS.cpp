...
void ModuleIO::saving_HS(const double *Hloc, const double* Sloc, const bool bit, const int &out_mat_hs, const std::string &file_name, const Parallel_Orbitals &pv)
{   
    if(out_mat_hs==1)
    {
...
void ModuleIO::save_HS(const double *H, const double *S, const bool bit, const std::string &file_name, const Parallel_Orbitals &pv)
{
...
//LiuXh, 2017-03-21
void ModuleIO::saving_HS(std::complex<double> *Hloc, std::complex<double>* Sloc, const bool bit, const int &out_mat_hs, const std::string &file_name, const Parallel_Orbitals &pv)
{   
    if(out_mat_hs==1)
    {
...
//LiuXh, 2017-03-21
void ModuleIO::save_HS_complex(std::complex<double> *H, std::complex<double> *S, const bool bit, const std::string &file_name, const Parallel_Orbitals &pv)
{
    ModuleBase::TITLE("ModuleIO","save_HS_bit");
    ModuleBase::timer::tick("ModuleIO","save_HS_bit");
    ModuleBase::GlobalFunc::OUT(GlobalV::ofs_running,"Dimension of H and S",GlobalV::NLOCAL);
