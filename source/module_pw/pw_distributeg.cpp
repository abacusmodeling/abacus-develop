...
)
{
    if (this->npw == 0)
    {
        ...
        this->ig2isz[0] = 0;
        if(this->is2ixy!=nullptr) delete[] this->is2ixy; this->is2ixy = new int[1]; // map is (index of sticks) to ixy (iy + ix * ny).
        this->is2ixy[0] = -1;
        return;
    }
    ...
    if(this->is2ixy!=nullptr) delete[] this->is2ixy; this->is2ixy = new int[this->nst]; // map is (index of sticks) to ixy (iy + ix * ny).
