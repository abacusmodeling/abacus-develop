        ...
        else
        {
            ...
            if (iter==1 && !onescf)
            {
                ...
                if (scf_thr < diago_error)
                {
                    ...
                    GlobalV::ofs_running << " Origin DIAG_THR_E = " << GlobalV::DIAG_THR_E << std::endl;
                    GlobalV::DIAG_THR_E = 0.1 * scf_thr / GlobalC::CHR.nelec;
                    GlobalV::ofs_running << " New    DIAG_THR_E = " << GlobalV::DIAG_THR_E << std::endl;
