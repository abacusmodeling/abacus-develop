...
Lebedev_laikov_grid::Lebedev_laikov_grid(int degree)
{
    ...
    this->degree = degree;
    grid_coor = new ModuleBase::Vector3<double>[degree];
...
void Lebedev_laikov_grid::generate_grid_points()
{
    ...
    case 6:
        ...
        start = getLebedevReccurencePoints(1, start, a, b, v);
    ...
    case 14:
        ...
        start = getLebedevReccurencePoints(3, start, a, b, v);
    ...
    case 26:
        ...
        start = getLebedevReccurencePoints(2, start, a, b, v);
    ...
    case 38:
        ...
        start = getLebedevReccurencePoints(5, start, a, b, v);
    ...
    case 50:
        ...
        start = getLebedevReccurencePoints(4, start, a, b, v);
    ...
    case 146:
        ...
        start = getLebedevReccurencePoints(6, start, a, b, v);
...
int Lebedev_laikov_grid::getLebedevReccurencePoints(int type, int start, double a, double b, double v)
{
    ...
    case 1:
        ...
        grid_coor[start].x = a;
        grid_coor[start].y = 0.0;
        grid_coor[start].z = 0.0;
        weight[start] = 4.0 * pi * v;

        grid_coor[start + 1].x = -a;
        grid_coor[start + 1].y = 0.0;
        grid_coor[start + 1].z = 0.0;
        weight[start + 1] = 4.0 * pi * v;

        grid_coor[start + 2].x = 0.0;
        grid_coor[start + 2].y = a;
        grid_coor[start + 2].z = 0.0;
        weight[start + 2] = 4.0 * pi * v;

        grid_coor[start + 3].x = 0.0;
        grid_coor[start + 3].y = -a;
        grid_coor[start + 3].z = 0.0;
        weight[start + 3] = 4.0 * pi * v;

        grid_coor[start + 4].x = 0.0;
        grid_coor[start + 4].y = 0.0;
        grid_coor[start + 4].z = a;
        weight[start + 4] = 4.0 * pi * v;

        grid_coor[start + 5].x = 0.0;
        grid_coor[start + 5].y = 0.0;
        grid_coor[start + 5].z = -a;
        weight[start + 5] = 4.0 * pi * v;
    ...
    case 2:
        ...
        grid_coor[start].x = 0.0;
        grid_coor[start].y = a;
        grid_coor[start].z = a;
        weight[start] = 4.0 * pi * v;

        grid_coor[start + 1].x = 0.0;
        grid_coor[start + 1].y = -a;
        grid_coor[start + 1].z = a;
        weight[start + 1] = 4.0 * pi * v;

        grid_coor[start + 2].x = 0.0;
        grid_coor[start + 2].y = a;
        grid_coor[start + 2].z = -a;
        weight[start + 2] = 4.0 * pi * v;

        grid_coor[start + 3].x = 0.0;
        grid_coor[start + 3].y = -a;
        grid_coor[start + 3].z = -a;
        weight[start + 3] = 4.0 * pi * v;

        grid_coor[start + 4].x = a;
        grid_coor[start + 4].y = 0.0;
        grid_coor[start + 4].z = a;
        weight[start + 4] = 4.0 * pi * v;

        grid_coor[start + 5].x = a;
        grid_coor[start + 5].y = 0.0;
        grid_coor[start + 5].z = -a;
        weight[start + 5] = 4.0 * pi * v;

        grid_coor[start + 6].x = -a;
        grid_coor[start + 6].y = 0.0;
        grid_coor[start + 6].z = a;
        weight[start + 6] = 4.0 * pi * v;

        grid_coor[start + 7].x = -a;
        grid_coor[start + 7].y = 0.0;
        grid_coor[start + 7].z = -a;
        weight[start + 7] = 4.0 * pi * v;

        grid_coor[start + 8].x = a;
        grid_coor[start + 8].y = a;
        grid_coor[start + 8].z = 0.0;
        weight[start + 8] = 4.0 * pi * v;

        grid_coor[start + 9].x = -a;
        grid_coor[start + 9].y = a;
        grid_coor[start + 9].z = 0.0;
        weight[start + 9] = 4.0 * pi * v;

        grid_coor[start + 10].x = a;
        grid_coor[start + 10].y = -a;
        grid_coor[start + 10].z = 0.0;
        weight[start + 10] = 4.0 * pi * v;

        grid_coor[start + 11].x = -a;
        grid_coor[start + 11].y = -a;
        grid_coor[start + 11].z = 0.0;
    ...
    case 3:
        ...
        grid_coor[start + 2].x = a;
        grid_coor[start + 2].y = -a;
        grid_coor[start + 2].z = a;
        weight[start + 2] = 4.0 * pi * v;

        grid_coor[start + 3].x = a;
        grid_coor[start + 3].y = a;
        grid_coor[start + 3].z = -a;
        weight[start + 3] = 4.0 * pi * v;

        grid_coor[start + 4].x = -a;
        grid_coor[start + 4].y = -a;
        grid_coor[start + 4].z = a;
        weight[start + 4] = 4.0 * pi * v;

        grid_coor[start + 5].x = a;
        grid_coor[start + 5].y = -a;
        grid_coor[start + 5].z = -a;
        weight[start + 5] = 4.0 * pi * v;

        grid_coor[start + 6].x = -a;
        grid_coor[start + 6].y = a;
        grid_coor[start + 6].z = -a;
        weight[start + 6] = 4.0 * pi * v;

        grid_coor[start + 7].x = -a;
        grid_coor[start + 7].y = -a;
        grid_coor[start + 7].z = -a;
        weight[start + 7] = 4.0 * pi * v;
    ...
    case 4:
        ...
        grid_coor[start + 1].x = -a;
        grid_coor[start + 1].y = a;
        grid_coor[start + 1].z = b;
        weight[start + 1] = 4.0 * pi * v;

        grid_coor[start + 2].x = a;
        grid_coor[start + 2].y = -a;
        grid_coor[start + 2].z = b;
        weight[start + 2] = 4.0 * pi * v;

        grid_coor[start + 3].x = a;
        grid_coor[start + 3].y = a;
        grid_coor[start + 3].z = -b;
        weight[start + 3] = 4.0 * pi * v;

        grid_coor[start + 4].x = -a;
        grid_coor[start + 4].y = -a;
        grid_coor[start + 4].z = b;
        weight[start + 4] = 4.0 * pi * v;

        grid_coor[start + 5].x = -a;
        grid_coor[start + 5].y = a;
        grid_coor[start + 5].z = -b;
        weight[start + 5] = 4.0 * pi * v;

        grid_coor[start + 6].x = a;
        grid_coor[start + 6].y = -a;
        grid_coor[start + 6].z = -b;
        weight[start + 6] = 4.0 * pi * v;

        grid_coor[start + 7].x = -a;
        grid_coor[start + 7].y = -a;
        grid_coor[start + 7].z = -b;
        weight[start + 7] = 4.0 * pi * v;

        grid_coor[start + 8].x = -a;
        grid_coor[start + 8].y = b;
        grid_coor[start + 8].z = a;
        weight[start + 8] = 4.0 * pi * v;

        grid_coor[start + 9].x = a;
        grid_coor[start + 9].y = -b;
        grid_coor[start + 9].z = a;
        weight[start + 9] = 4.0 * pi * v;

        grid_coor[start + 10].x = a;
        grid_coor[start + 10].y = b;
        grid_coor[start + 10].z = -a;
        weight[start + 10] = 4.0 * pi * v;

        grid_coor[start + 11].x = -a;
        grid_coor[start + 11].y = -b;
        grid_coor[start + 11].z = a;
        weight[start + 11] = 4.0 * pi * v;

        grid_coor[start + 12].x = -a;
        grid_coor[start + 12].y = b;
        grid_coor[start + 12].z = -a;
        weight[start + 12] = 4.0 * pi * v;

        grid_coor[start + 13].x = a;
        grid_coor[start + 13].y = -b;
        grid_coor[start + 13].z = -a;
        weight[start + 13] = 4.0 * pi * v;

        grid_coor[start + 14].x = -a;
        grid_coor[start + 14].y = -b;
        grid_coor[start + 14].z = -a;
        weight[start + 14] = 4.0 * pi * v;

        grid_coor[start + 15].x = a;
        grid_coor[start + 15].y = b;
        grid_coor[start + 15].z = a;
        weight[start + 15] = 4.0 * pi * v;

        grid_coor[start + 16].x = b;
        grid_coor[start + 16].y = a;
        grid_coor[start + 16].z = a;
        weight[start + 16] = 4.0 * pi * v;

        grid_coor[start + 17].x = -b;
        grid_coor[start + 17].y = a;
        grid_coor[start + 17].z = a;
        weight[start + 17] = 4.0 * pi * v;

        grid_coor[start + 18].x = b;
        grid_coor[start + 18].y = -a;
        grid_coor[start + 18].z = a;
        weight[start + 18] = 4.0 * pi * v;

        grid_coor[start + 19].x = b;
        grid_coor[start + 19].y = a;
        grid_coor[start + 19].z = -a;
        weight[start + 19] = 4.0 * pi * v;

        grid_coor[start + 20].x = -b;
        grid_coor[start + 20].y = -a;
        grid_coor[start + 20].z = a;
        weight[start + 20] = 4.0 * pi * v;

        grid_coor[start + 21].x = -b;
        grid_coor[start + 21].y = a;
        grid_coor[start + 21].z = -a;
        weight[start + 21] = 4.0 * pi * v;

        grid_coor[start + 22].x = b;
        grid_coor[start + 22].y = -a;
        grid_coor[start + 22].z = -a;
        weight[start + 22] = 4.0 * pi * v;

        grid_coor[start + 23].x = -b;
        grid_coor[start + 23].y = -a;
        grid_coor[start + 23].z = -a;
        weight[start + 23] = 4.0 * pi * v;
    ...
    case 5:
        ...
        grid_coor[start + 1].x = -a;
        grid_coor[start + 1].y = b;
        grid_coor[start + 1].z = 0.0;
        weight[start + 1] = 4.0 * pi * v;

        grid_coor[start + 2].x = a;
        grid_coor[start + 2].y = -b;
        grid_coor[start + 2].z = 0.0;
        weight[start + 2] = 4.0 * pi * v;

        grid_coor[start + 3].x = -a;
        grid_coor[start + 3].y = -b;
        grid_coor[start + 3].z = 0.0;
        weight[start + 3] = 4.0 * pi * v;

        grid_coor[start + 4].x = b;
        grid_coor[start + 4].y = a;
        grid_coor[start + 4].z = 0.0;
        weight[start + 4] = 4.0 * pi * v;

        grid_coor[start + 5].x = -b;
        grid_coor[start + 5].y = a;
        grid_coor[start + 5].z = 0.0;
        weight[start + 5] = 4.0 * pi * v;

        grid_coor[start + 6].x = b;
        grid_coor[start + 6].y = -a;
        grid_coor[start + 6].z = 0.0;
        weight[start + 6] = 4.0 * pi * v;

        grid_coor[start + 7].x = -b;
        grid_coor[start + 7].y = -a;
        grid_coor[start + 7].z = 0.0;
        weight[start + 7] = 4.0 * pi * v;

        grid_coor[start + 8].x = a;
        grid_coor[start + 8].y = 0.0;
        grid_coor[start + 8].z = b;
        weight[start + 8] = 4.0 * pi * v;

        grid_coor[start + 9].x = -a;
        grid_coor[start + 9].y = 0.0;
        grid_coor[start + 9].z = b;
        weight[start + 9] = 4.0 * pi * v;

        grid_coor[start + 10].x = a;
        grid_coor[start + 10].y = 0.0;
        grid_coor[start + 10].z = -b;
        weight[start + 10] = 4.0 * pi * v;
        ...
        grid_coor[start + 13].x = -b;
        grid_coor[start + 13].y = 0.0;
        grid_coor[start + 13].z = a;
        weight[start + 13] = 4.0 * pi * v;

        grid_coor[start + 14].x = b;
        grid_coor[start + 14].y = 0.0;
        grid_coor[start + 14].z = -a;
        weight[start + 14] = 4.0 * pi * v;

        grid_coor[start + 15].x = -b;
        grid_coor[start + 15].y = 0.0;
        grid_coor[start + 15].z = -a;
        weight[start + 15] = 4.0 * pi * v;

        grid_coor[start + 16].x = 0.0;
        grid_coor[start + 16].y = a;
        grid_coor[start + 16].z = b;
        weight[start + 16] = 4.0 * pi * v;

        grid_coor[start + 17].x = 0.0;
        grid_coor[start + 17].y = -a;
        grid_coor[start + 17].z = b;
        weight[start + 17] = 4.0 * pi * v;

        grid_coor[start + 18].x = 0.0;
        grid_coor[start + 18].y = a;
        grid_coor[start + 18].z = -b;
        weight[start + 18] = 4.0 * pi * v;

        grid_coor[start + 19].x = 0.0;
        grid_coor[start + 19].y = -a;
        grid_coor[start + 19].z = -b;
        weight[start + 19] = 4.0 * pi * v;

        grid_coor[start + 20].x = 0.0;
        grid_coor[start + 20].y = b;
        grid_coor[start + 20].z = a;
        weight[start + 20] = 4.0 * pi * v;

        grid_coor[start + 21].x = 0.0;
        grid_coor[start + 21].y = -b;
        grid_coor[start + 21].z = a;
        weight[start + 21] = 4.0 * pi * v;

        grid_coor[start + 22].x = 0.0;
        grid_coor[start + 22].y = b;
        grid_coor[start + 22].z = -a;
        weight[start + 22] = 4.0 * pi * v;

        grid_coor[start + 23].x = 0.0;
        grid_coor[start + 23].y = -b;
        grid_coor[start + 23].z = -a;
        weight[start + 23] = 4.0 * pi * v;
    ...
    case 6:
        ...
        grid_coor[start + 1].x = -a;
        grid_coor[start + 1].y = b;
        grid_coor[start + 1].z = c;
        weight[start + 1] = 4.0 * pi * v;

        grid_coor[start + 2].x = a;
        grid_coor[start + 2].y = -b;
        grid_coor[start + 2].z = c;
        weight[start + 2] = 4.0 * pi * v;

        grid_coor[start + 3].x = a;
        grid_coor[start + 3].y = b;
        grid_coor[start + 3].z = -c;
        weight[start + 3] = 4.0 * pi * v;

        grid_coor[start + 4].x = -a;
        grid_coor[start + 4].y = -b;
        grid_coor[start + 4].z = c;
        weight[start + 4] = 4.0 * pi * v;

        grid_coor[start + 5].x = a;
        grid_coor[start + 5].y = -b;
        grid_coor[start + 5].z = -c;
        weight[start + 5] = 4.0 * pi * v;

        grid_coor[start + 6].x = -a;
        grid_coor[start + 6].y = b;
        grid_coor[start + 6].z = -c;
        weight[start + 6] = 4.0 * pi * v;

        grid_coor[start + 7].x = -a;
        grid_coor[start + 7].y = -b;
        grid_coor[start + 7].z = -c;
        weight[start + 7] = 4.0 * pi * v;

        grid_coor[start + 8].x = b;
        grid_coor[start + 8].y = a;
        grid_coor[start + 8].z = c;
        weight[start + 8] = 4.0 * pi * v;

        grid_coor[start + 9].x = -b;
        grid_coor[start + 9].y = a;
        grid_coor[start + 9].z = c;
        weight[start + 9] = 4.0 * pi * v;

        grid_coor[start + 10].x = b;
        grid_coor[start + 10].y = -a;
        grid_coor[start + 10].z = c;
        weight[start + 10] = 4.0 * pi * v;

        grid_coor[start + 11].x = b;
        grid_coor[start + 11].y = a;
        grid_coor[start + 11].z = -c;
        weight[start + 11] = 4.0 * pi * v;

        grid_coor[start + 12].x = -b;
        grid_coor[start + 12].y = -a;
        grid_coor[start + 12].z = c;
        weight[start + 12] = 4.0 * pi * v;

        grid_coor[start + 13].x = b;
        grid_coor[start + 13].y = -a;
        grid_coor[start + 13].z = -c;
        weight[start + 13] = 4.0 * pi * v;

        grid_coor[start + 14].x = -b;
        grid_coor[start + 14].y = a;
        grid_coor[start + 14].z = -c;
        weight[start + 14] = 4.0 * pi * v;

        grid_coor[start + 15].x = -b;
        grid_coor[start + 15].y = -a;
        grid_coor[start + 15].z = -c;
        weight[start + 15] = 4.0 * pi * v;

        grid_coor[start + 16].x = c;
        grid_coor[start + 16].y = a;
        grid_coor[start + 16].z = b;
        weight[start + 16] = 4.0 * pi * v;

        grid_coor[start + 17].x = -c;
        grid_coor[start + 17].y = a;
        grid_coor[start + 17].z = b;
        weight[start + 17] = 4.0 * pi * v;

        grid_coor[start + 18].x = c;
        grid_coor[start + 18].y = -a;
        grid_coor[start + 18].z = b;
        weight[start + 18] = 4.0 * pi * v;

        grid_coor[start + 19].x = c;
        grid_coor[start + 19].y = a;
        grid_coor[start + 19].z = -b;
        weight[start + 19] = 4.0 * pi * v;

        grid_coor[start + 20].x = -c;
        grid_coor[start + 20].y = -a;
        grid_coor[start + 20].z = b;
        weight[start + 20] = 4.0 * pi * v;

        grid_coor[start + 21].x = c;
        grid_coor[start + 21].y = -a;
        grid_coor[start + 21].z = -b;
        weight[start + 21] = 4.0 * pi * v;

        grid_coor[start + 22].x = -c;
        grid_coor[start + 22].y = a;
        grid_coor[start + 22].z = -b;
        weight[start + 22] = 4.0 * pi * v;

        grid_coor[start + 23].x = -c;
        grid_coor[start + 23].y = -a;
        grid_coor[start + 23].z = -b;
        weight[start + 23] = 4.0 * pi * v;

        grid_coor[start + 24].x = c;
        grid_coor[start + 24].y = b;
        grid_coor[start + 24].z = a;
        weight[start + 24] = 4.0 * pi * v;

        grid_coor[start + 25].x = -c;
        grid_coor[start + 25].y = b;
        grid_coor[start + 25].z = a;
        weight[start + 25] = 4.0 * pi * v;

        grid_coor[start + 26].x = c;
        grid_coor[start + 26].y = -b;
        grid_coor[start + 26].z = a;
        weight[start + 26] = 4.0 * pi * v;

        grid_coor[start + 27].x = c;
        grid_coor[start + 27].y = b;
        grid_coor[start + 27].z = -a;
        weight[start + 27] = 4.0 * pi * v;

        grid_coor[start + 28].x = -c;
        grid_coor[start + 28].y = -b;
        grid_coor[start + 28].z = a;
        weight[start + 28] = 4.0 * pi * v;

        grid_coor[start + 29].x = c;
        grid_coor[start + 29].y = -b;
        grid_coor[start + 29].z = -a;
        weight[start + 29] = 4.0 * pi * v;

        grid_coor[start + 30].x = -c;
        grid_coor[start + 30].y = b;
        grid_coor[start + 30].z = -a;
        weight[start + 30] = 4.0 * pi * v;

        grid_coor[start + 31].x = -c;
        grid_coor[start + 31].y = -b;
        grid_coor[start + 31].z = -a;
        weight[start + 31] = 4.0 * pi * v;

        grid_coor[start + 32].x = a;
        grid_coor[start + 32].y = c;
        grid_coor[start + 32].z = b;
        weight[start + 32] = 4.0 * pi * v;

        grid_coor[start + 33].x = -a;
        grid_coor[start + 33].y = c;
        grid_coor[start + 33].z = b;
        weight[start + 33] = 4.0 * pi * v;

        grid_coor[start + 34].x = a;
        grid_coor[start + 34].y = -c;
        grid_coor[start + 34].z = b;
        weight[start + 34] = 4.0 * pi * v;

        grid_coor[start + 35].x = a;
        grid_coor[start + 35].y = c;
        grid_coor[start + 35].z = -b;
        weight[start + 35] = 4.0 * pi * v;

        grid_coor[start + 36].x = -a;
        grid_coor[start + 36].y = -c;
        grid_coor[start + 36].z = b;
        weight[start + 36] = 4.0 * pi * v;

        grid_coor[start + 37].x = a;
        grid_coor[start + 37].y = -c;
        grid_coor[start + 37].z = -b;
        weight[start + 37] = 4.0 * pi * v;

        grid_coor[start + 38].x = -a;
        grid_coor[start + 38].y = c;
        grid_coor[start + 38].z = -b;
        weight[start + 38] = 4.0 * pi * v;

        grid_coor[start + 39].x = -a;
        grid_coor[start + 39].y = -c;
        grid_coor[start + 39].z = -b;
        weight[start + 39] = 4.0 * pi * v;

        grid_coor[start + 40].x = b;
        grid_coor[start + 40].y = c;
        grid_coor[start + 40].z = a;
        weight[start + 40] = 4.0 * pi * v;

        grid_coor[start + 41].x = -b;
        grid_coor[start + 41].y = c;
        grid_coor[start + 41].z = a;
        weight[start + 41] = 4.0 * pi * v;

        grid_coor[start + 42].x = b;
        grid_coor[start + 42].y = -c;
        grid_coor[start + 42].z = a;
        weight[start + 42] = 4.0 * pi * v;

        grid_coor[start + 43].x = b;
        grid_coor[start + 43].y = c;
        grid_coor[start + 43].z = -a;
        weight[start + 43] = 4.0 * pi * v;

        grid_coor[start + 44].x = -b;
        grid_coor[start + 44].y = -c;
        grid_coor[start + 44].z = a;
        weight[start + 44] = 4.0 * pi * v;

        grid_coor[start + 45].x = b;
        grid_coor[start + 45].y = -c;
        grid_coor[start + 45].z = -a;
        weight[start + 45] = 4.0 * pi * v;

        grid_coor[start + 46].x = -b;
        grid_coor[start + 46].y = c;
        grid_coor[start + 46].z = -a;
        weight[start + 46] = 4.0 * pi * v;

        grid_coor[start + 47].x = -b;
        grid_coor[start + 47].y = -c;
        grid_coor[start + 47].z = -a;
        weight[start + 47] = 4.0 * pi * v;
