...
void Ions_Move_CG::start(const ModuleBase::matrix& force, const double& etot_in)
{
	...
	{
		steplength=Ions_Move_Basic::bfgs_init;          // read in the init trust radius
		//std::cout<<"Ions_Move_Basic::bfgs_init = "<<Ions_Move_Basic::bfgs_init<<std::endl;
		sd = true;
		trial = true;
		ncggrad = 0;
