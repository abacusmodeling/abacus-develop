...
void Lattice_Change_Basic::setup_gradient(double* lat, double *grad, ModuleBase::matrix &stress)
{
	...
	lat[0] = GlobalC::ucell.latvec.e11 * GlobalC::ucell.lat0;   lat[1] = GlobalC::ucell.latvec.e12 * GlobalC::ucell.lat0; lat[2] = GlobalC::ucell.latvec.e13 * GlobalC::ucell.lat0; 
	lat[3] = GlobalC::ucell.latvec.e21 * GlobalC::ucell.lat0;   lat[4] = GlobalC::ucell.latvec.e22 * GlobalC::ucell.lat0; lat[5] = GlobalC::ucell.latvec.e23 * GlobalC::ucell.lat0;
	lat[6] = GlobalC::ucell.latvec.e31 * GlobalC::ucell.lat0;   lat[7] = GlobalC::ucell.latvec.e32 * GlobalC::ucell.lat0; lat[8] = GlobalC::ucell.latvec.e33 * GlobalC::ucell.lat0;
...
*/
	...
	GlobalC::ucell.omega = abs( GlobalC::ucell.latvec.Det() ) * GlobalC::ucell.lat0 * GlobalC::ucell.lat0 * GlobalC::ucell.lat0;
