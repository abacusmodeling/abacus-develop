...
namespace Ions_Move_Basic
{
	...
	extern double bfgs_rmax; // max value of trust radius,
	extern double bfgs_rmin; // min value of trust radius,
	extern double bfgs_init; // initial value of trust radius,
