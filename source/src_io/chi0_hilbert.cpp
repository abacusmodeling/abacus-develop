...
std::complex<double> *** Chi0_hilbert::WFC_K = nullptr;
Chi0_hilbert::Chi0_hilbert()
         :init_finish(false)
{
    epsilon = false;
			...
			for(int ib2=0; ib2<GlobalV::NBANDS; ib2++)
			{
				...
				for(int iw1=0; iw1<GlobalV::NLOCAL; iw1++)
				{
					for(int iw2=0; iw2<GlobalV::NLOCAL; iw2++)
					{
						for(int ir=0; ir<Rmax[iw1][iw2]; ir++)
						{
							b[ig][ib1][ib2] += conj(this->WFC_K[ik][ib1][iw1]) * this->WFC_K[iqk][ib2][iw2] * overlap[iw1][iw2][ig][ir] * phase[iw1][iw2][ir];
						}
					}
				}
			}
		...
		for(int ib1=0; ib1<oband; ib1++)
		{
			...
			for(int iw1=0; iw1<GlobalV::NLOCAL; iw1++)
			{
				for(int iw2=0; iw2<GlobalV::NLOCAL; iw2++)
				{
					for(int ir=0; ir<Rmax[iw1][iw2]; ir++)
					{
						left[ib1][r] = conj(this->WFC_K[ik][ib1][iw1]) * overlap[iw1][iw2][ig][ir] * phase[iw1][iw2][ir];
						r++;
					}
				}
			}
		...
		for(int ib2=0; ib2<GlobalV::NBANDS; ib2++)
		{
			...
			for(int iw1=0; iw1<GlobalV::NLOCAL; iw1++)
			{
				for(int iw2=0; iw2<GlobalV::NLOCAL; iw2++)
				{
					for(int ir=0; ir<Rmax[iw1][iw2]; ir++)
					{
						right[r][ib2] = this->WFC_K[iqk][ib2][iw2];
						r++;
					}
				}
			}
