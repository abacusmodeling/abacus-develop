...
{
    public:
    ELPA_Solver(const bool isReal, const MPI_Comm comm, const int nev, const int narows, const int nacols, const int* desc);
    ...
    int generalized_eigenvector(std::complex<double>* A, std::complex<double>* B, int& DecomposedState,
    ...
    void verify(double* A, double* B, double* EigenValue, double* EigenVector,
                double &maxRemain, double &meanRemain);
	void verify(std::complex<double>* A, double* EigenValue, std::complex<double>* EigenVector,
                         double &maxError, double &meanError);
	void verify(std::complex<double>* A, std::complex<double>* B,
                double* EigenValue, std::complex<double>* EigenVector,
                double &maxError, double &meanError);
    void exit();
