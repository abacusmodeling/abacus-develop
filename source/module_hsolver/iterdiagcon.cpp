    ...
    int n_band)
{
	...
	char trans1 = 'C';
	char trans2 = 'N';
	zgemm_(&trans1,&trans2,&nstart,&nstart,&dmin,&ModuleBase::ONE,ppsi,&dmax,paux,&dmax,&ModuleBase::ZERO,hc.c,&nstart);
	hc=transpose(hc,false);

	zgemm_(&trans1,&trans2,&nstart,&nstart,&dmin,&ModuleBase::ONE,ppsi,&dmax,ppsi,&dmax,&ModuleBase::ZERO,sc.c,&nstart);
	...
	else
	{
		...
		zgemm_(&transa,&transb,&dmin,&n_band,&nstart,&ModuleBase::ONE,ppsi,&dmax,hvec.c,&n_band,&ModuleBase::ZERO,evctmp.c,&dmin);
