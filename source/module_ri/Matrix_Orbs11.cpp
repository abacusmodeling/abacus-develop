...
#include "src_ri/exx_abfs.h"			// tmp. for Exx_Abfs::Lmax
...
//		GlobalC::ORB.get_dk() / kmesh_times);				// delta k, for integration in k space
	...
	int Lmax_used, Lmax;
	this->MOT.init_Table_Spherical_Bessel (2, mode, Lmax_used, Lmax, Exx_Abfs::Lmax,GlobalC::ORB, GlobalC::ucell.infoNL.Beta);
