...
void Lattice_Change_Basic::setup_gradient(double* lat, double *grad, const matrix &stress)
{
...
void Lattice_Change_Basic::check_converged(const matrix &stress)
{
	...
	{
                ofs_running << "\n Lattice relaxation is not converged yet (threshold is "
                << STRESS_THR << ")" << endl;
