...
# ------------------------------------------------------------------------
# generate arch file for compiling ABACUS
# ------------------------------------------------------------------------
...
# generator for ABACUS ARCH files
gen_arch_file() {
...
Done!
Now copy:
  cp ${INSTALLDIR}/arch/* to the ABACUS/arch/ directory
To use the installed tools and libraries and ABACUS version
compiled with it you will first need to execute at the prompt:
  source ${SETUPFILE}
To build ABACUS you should change directory:
  cd ABACUS/
...
It is possible to use the provided ABACUS arch files as guidance.
EOF
